import { createAnonDecrypter, createAuthDecrypter, decryptJWE, createAnonEncrypter, createJWE, createAuthEncrypter, verifyJWS, } from 'did-jwt';
import { parse as parseDidUrl } from 'did-resolver';
import schema from "./plugin.schema.json" assert { type: 'json' };
import { v4 as uuidv4 } from 'uuid';
import * as u8a from 'uint8arrays';
import { createEcdhWrapper, extractSenderEncryptionKey, extractManagedRecipients, mapRecipientsToLocalKeys, } from './utils.js';
import { decodeJoseBlob, dereferenceDidKeys, encodeJoseBlob, isDefined, mapIdentifierKeysToDoc, resolveDidOrThrow, } from '@veramo/utils';
...
export class DIDComm {
    ...
    async packDIDCommMessageJWE(args, context) {
        ...
        const encrypters = recipients
            .map((recipient) => {
            if (args.packing === 'authcrypt') {
                return createAuthEncrypter(recipient.publicKeyBytes, senderECDH, { kid: recipient.kid });
            }
            else {
